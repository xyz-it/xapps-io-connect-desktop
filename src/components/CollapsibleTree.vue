...
<script>
    ...
    var margin = ({top: 120, right: 200, bottom: 120, left: 200});
    var width = 1200;
    var dy = width / 4;
    var dx = dx = 120;
    ...
    let chart = () => {
        ...
        function update(source) {
            ...
            nodeEnter.append("circle")
                .attr("r", d => d._children ? 20 : 17)
                .attr("fill", d => (d.data.type === "Project") ? "blue" :
                    (d.data.type === "Key Decision") ? "purple" :
                        (d.data.type === "Knowledge Gap") ? "orange" : "green")
                .attr("stroke-width", 3)
                .attr("stroke", "gray");
